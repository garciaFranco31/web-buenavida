    ...
    return rx.el.section(
        rx.el.div(
            ...
            rx.el.div(
                rx.el.a(
                    rx.el.i(
                        class_name="fa-brands fa-instagram text-6xl text-gray-500 hover:text-sky-500 transition-colors",
                        _hover= {"color": ThemeState.primary_complementary}
                    ),
                    href="https://www.instagram.com/buenavida.clubsocial?igsh=Z2dueGE0ZmVwemV6",
                ),
                rx.el.a(
                    rx.el.i(
                        class_name=f"fa-brands fa-square-facebook text-6xl text-gray-500 hover:ThemeState.primary_color transition-colors",
                        _hover= {"color": ThemeState.primary_complementary}
                    ),
                    href="#",
                ),
